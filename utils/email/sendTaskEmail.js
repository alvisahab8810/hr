      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 32px rgba(0,0,0,0.10);">
        ...
        <tr>
          <td style="padding:0 48px 36px;text-align:left;">
            <a href="${process.env.NEXT_PUBLIC_APP_URL || "https://viralon.in"}/employee/portal" style="display:inline-block;padding:12px 28px;background:linear-gradient(135deg,#5A57FB,#4845d4);color:#ffffff;font-size:14px;font-weight:700;border-radius:10px;text-decoration:none;letter-spacing:0.2px;">
              Open Portal &rarr;
            </a>
          </td>
        </tr>
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 32px rgba(0,0,0,0.10);">
        ...
        <tr>
          <td style="padding:0 48px 36px;">
            <a href="${process.env.NEXT_PUBLIC_APP_URL || "https://viralon.in"}/dashboard/admin/task-requests" style="display:inline-block;padding:12px 28px;background:linear-gradient(135deg,#5A57FB,#4845d4);color:#ffffff;font-size:14px;font-weight:700;border-radius:10px;text-decoration:none;">

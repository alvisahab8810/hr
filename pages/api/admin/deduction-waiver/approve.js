// pages/api/admin/deduction-waiver/approve.js
...
export default async function handler(req, res) {
  ...
  waiver.approvedBy  = admin._id;
  waiver.approvedAt  = new Date();
  await waiver.save();

  return res.json({ success: true, data: waiver, message: "Waiver approved. Deduction will be excluded on next salary generation." });
}

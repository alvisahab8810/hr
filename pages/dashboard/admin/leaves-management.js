                          ...
                          <td>
                            ...
                            {leave.status === "Approved" && (
                              <button
                                ...
                                onClick={async () => {
                                  if (!(await confirmDialog(`${leave.employee?.firstName} ${leave.employee?.lastName} — revoke this ${leave.leaveType} (${leave.totalDays} day)? The balance will be restored and the leave deleted.`))) return;
                                  try {
